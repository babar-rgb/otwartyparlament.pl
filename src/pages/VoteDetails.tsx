    ...
    return (
        <div className="min-h-screen bg-neutral-50 text-neutral-900 p-6 md:p-12 font-sans">
            <div className="max-w-5xl mx-auto space-y-8">
                ...
                {/* AI Analysis Section */}
                {analysis && (
                    <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-3xl p-8 shadow-sm border border-indigo-100 relative overflow-hidden">
                        ...
                        <div className="relative z-10 space-y-6">
                            <div className="flex items-center gap-3">
                                ...
                                <h2 className="text-2xl font-bold text-indigo-900">Analiza AI</h2>
                            </div>
                            ...
                            <div className="text-xs text-indigo-400 text-center pt-2">
